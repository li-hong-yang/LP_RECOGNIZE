...
def parse_arg():
    ...
    parser.add_argument('--image_dir', type=str,
                        ...
                        # default='/home/hyli/project/OCR/deblur/SRN-DeblurNet/blue_resize_hc/',
                        # default="/home/hyli/project/OCR/OCR_datasets/testg/",
                        default='/home/hyli/project/OCR/OCR_datasets/lp_rec_wrong/',
    ...
    parser.add_argument('--checkpoint', type=str,
                        ...
                        # default='/home/hyli/project/OCR/CRNN_Chinese_Characters_Rec/output/OWN/crnn/2021-01-05-17-46/checkpoints/checkpoint_199_acc_0.8179.pth',
                        default='/home/hyli/project/OCR/CRNN_Chinese_Characters_Rec/output/OWN/crnn/2021-02-07-17-35/checkpoints/checkpoint_121_acc_0.8620.pth',
...
def recognition(config, img, model, converter, device,image_name=None):
    ...
    return judge_correct(sim_pred,label),judge_len(sim_pred,label),judge_first(sim_pred,label),sim_pred

def infer_save_img(save_path,img,label):
    if not os.path.exists(save_path):
        os.makedirs(save_path)
    img_path = os.path.join(save_path,label+'.jpg')
...
if __name__ == '__main__':
    ...
    for image_name in os.listdir(args.image_dir):
        ...
        flag,len_flag,first_flag,sim_pred = recognition(config, img, model, converter, device,image_name)
        infer_save_img('./infer_save',img,sim_pred)
        right_sum += flag
        len_wrong += len_flag
